...
ifeq ($(config),debug64)
  ...
  TARGET     = $(TARGETDIR)/resourced
  DEFINES   += -D__orxDEBUG__
  INCLUDES  += -I../../../include -I../../../include/orx
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
  CFLAGS    += $(CPPFLAGS) $(ARCH) -msse2 -ffast-math -g -m64
  CXXFLAGS  += $(CFLAGS) -fno-exceptions
  LDFLAGS   += -L../../../lib/linux64 -m64 -L/usr/lib64
...
ifeq ($(config),debug32)
  ...
  CXXFLAGS  += $(CFLAGS) -fno-exceptions
  LDFLAGS   += -L../../../lib/linux32 -m32 -L/usr/lib32
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LIBS      += -lorxd -ldl -lm -lrt
  LDDEPS    += 
  LINKCMD    = $(CXX) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(LIBS) $(LDFLAGS)
